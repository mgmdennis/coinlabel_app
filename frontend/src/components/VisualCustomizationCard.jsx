    ...
    return (
        ...
        <Card withBorder shadow="sm" mb="lg" padding="md" style={{ borderColor: 'var(--mantine-color-blue-6)' }}>
            ...
            <Stack gap="md" mt="md">
                ...
                <div>
                    <Text size="sm" fw={700} mb={6}>Visual Source</Text>
                ...
                {visualTarget === 'PASTED' && !isManualMode && (obverseImageUrl || reverseImageUrl) && (
                    <div>
                        <Text size="sm" fw={700} mb={4}>Copy from Numista</Text>
                ...
                {visualTarget === 'PASTED' && (
                    <div>
                        <Text size="sm" fw={700} mb={4}>Coin Image</Text>
                ...
                {visualTarget === 'NUMISTA' && (
                    <div>
                        <Text size="sm" fw={700} mb={6}>Coin Side</Text>
                ...
                {needsGeneration && (
                    <Grid align="flex-end" gutter="sm">
                        <Grid.Col span="auto">
                            <div>
                                <Text size="sm" fw={700} mb={6}>Processing Method</Text>
